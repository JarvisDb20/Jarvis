...
class ExibeComicsFragment : Fragment(), ExibeComicsAdapter.comicOnClickListener {
    ...
    //lista dos comics
    lateinit var listComics: ArrayList<Results>

    //variaveis do viewpager
    var layoutStarted = false

    //lista apenas as imagens dos comics
    lateinit var listImages: ArrayList<ItemImageComic>
    ...
    override fun onCreateView(
        ...
        view.btn_exibe_char.setOnClickListener {
            val passaArgsComic = ExibeComicsFragmentDirections.navigateComicsToPersonagem(args.apiObjeto)
