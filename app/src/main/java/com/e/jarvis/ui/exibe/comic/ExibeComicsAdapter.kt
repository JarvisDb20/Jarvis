...
class ExibeComicsAdapter(
    var listImagensComics: ArrayList<ItemImageComic>,
    ...
    override fun onBindViewHolder(holder: ComicViewHolder, position: Int) {
        ...
        picasso.load(comic.thumbnailComic.path + "/landscape_incredible." + comic.thumbnailComic.extension)
    ...
    fun updateList(list: ArrayList<ItemImageComic>) {
